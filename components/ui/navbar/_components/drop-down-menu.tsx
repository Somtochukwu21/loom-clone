...
export const DropDownMenu: React.FC<DropDownMenuProps> = ({ onClose }) => {
	...
	return (
		<div className="w-screen h-screen bg-white pt-20 px-4 items-center justify-center absolute top-20 right-0 xl:hidden">
			<Accordion className="pl-2" type="single" collapsible>
				...
				<Link
					href={"/pricing"}
					className="flex flex-1 items-center justify-between text-xl px-6  py-4 my-6 border-b">
					Pricing
					<div>
				...
				<Link
					href={"/contact"}
					className="flex flex-1 items-center justify-between text-xl px-6  py-4 my-6">
					Contact Sales
					<div>
						<ArrowRight className="h-6 w-6 "/>
					</div>
