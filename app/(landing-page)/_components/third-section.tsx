	...
	return (
		<div className="py-20 items-center flex flex-col justify-center">
			<div className="px-12">
				...
				<div className="pt-6 py-16 md:pb-24 text-[#3d2e7c] text-xl md:text-3xl font-light items-center flex justify-center">
							...
							<div className="text-2xl md:text-4xl items-center flex w-full md:w-1/2 order-2 md:order-1">
								<div className="flex space-x-10 w-full">
									...
									<div>
										...
										<Button className="font-light md:text-lg mt-6 rounded-[40px] border-4 border-indigo-400/90 py-6 bg-[#565add] hover:scale-110 hover:shadow-indigo-500 transition-all duration-300 shadow-md">
											Download Now
										</Button>
									</div>
								</div>
