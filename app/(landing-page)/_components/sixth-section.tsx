...
export const SixthSection = () => {
	return (
		<div className="py-20 px-10">
			<div className="text-[#2b1c50] text-center justify-center items-center text-4xl md:text-6xl font-medium md:pb-20 mb-10 flex">
				Video messaging for all use cases
			</div>
			<div className="md:flex flex-wrap items-center justify-center space-y-10 md:space-y-0 gap-10">
				<div className="bg-[#e8f5e3] rounded-[40px] md:w-80 p-10 hover:scale-105 hover:shadow-xl">
					...
					<div className="text-[#315b39] text-center leading-8 pt-4 h-24">
						Sell more effectively with video messaging that is is easy to create
						and share.
					</div>
				</div>
			...
			<div className="flex items-center justify-center pt-20">
				<Button className="text-lg mt-6 rounded-[40px] text-[#4b42ad] font-medium p-6 bg-[#eff0ff] hover:scale-110 hover:shadow-indigo-500 duration-300 transition-all shadow-md">
					See all use cases
				</Button>
			</div>
		</div>
